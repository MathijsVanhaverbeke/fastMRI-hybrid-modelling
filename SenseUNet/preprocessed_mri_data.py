    ...
    def __init__(
        ...
        Args:
            ...
            transforms: Optional; A sequence of callable objects that
                ...
                function should take 'sense_data', 'target', 'attributes',
...
class SliceDataset(torch.utils.data.Dataset):
    ...
    def __init__(
        ...
        Args:
            ...
            transform: Optional; A callable object that pre-processes the raw
                ...
                'sense_data', 'target', 'attributes', 'filename', and 'slice' as
    ...
    def _retrieve_metadata(self, fname):
        with h5py.File(fname, "r") as hf:
            ...
            #################################################################################
            # Should be the same number of slices as the number of slices in the sense data #
            #################################################################################
    ...
    def __getitem__(self, i: int):
        ...
        with h5py.File(fname, "r") as hf:
            ...
            sense_data = hf["sense_data"][dataslice]
        ...
        if self.transform is None:
            # sample = (sense_data, mask, target, attrs, fname.name, dataslice)
            sample = (sense_data, target, attrs, fname.name, dataslice)
        else:
            # sample = self.transform(sense_data, mask, target, attrs, fname.name, dataslice)
            sample = self.transform(sense_data, target, attrs, fname.name, dataslice)
