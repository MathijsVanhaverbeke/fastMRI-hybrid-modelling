### DeepMRIRec version 2 - With optimized memory (so it now has LeakyReLU and uses batches of only 8 slices, amongst which are augmented slices)
...
path_to_checkpoints = '/usr/local/micapollo01/MIC/DATA/STUDENTS/mvhave7/Results/Models/ExtensiveSaves/'
model_checkpoints = file_paths_test_GT = sorted(glob.glob(path_to_checkpoints+"DeepMRIRec_*"))

evaluation_save_path = '/usr/local/micapollo01/MIC/DATA/STUDENTS/mvhave7/Results/Reconstructions/DeepMRIRec/Evaluations/'
