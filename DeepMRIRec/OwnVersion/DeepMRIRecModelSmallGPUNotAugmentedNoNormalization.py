...
from tensorflow.keras.layers import ReLU, PReLU, ReLU, LeakyReLU, add, Attention, Dropout
...
model_name = "/usr/local/micapollo01/MIC/DATA/STUDENTS/mvhave7/Results/Models/UnaugmentedExtensiveSavesOwnVersionNoNormalization/DeepMRIRec_trained_in_small_batches_GPU_epoch{epoch:02d}.h5"
...
model.save_weights("/usr/local/micapollo01/MIC/DATA/STUDENTS/mvhave7/Results/Models/UnaugmentedExtensiveSavesOwnVersionNoNormalization/final_model_DeepMRIRec_trained_in_small_batches_GPU.h5")
