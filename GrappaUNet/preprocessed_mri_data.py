    ...
    def __init__(
        ...
        Args:
            ...
            transforms: Optional; A sequence of callable objects that
                ...
                function should take 'grappa_data', 'target', 'attributes',
...
class SliceDataset(torch.utils.data.Dataset):
    ...
    def __init__(
        ...
        Args:
            ...
            transform: Optional; A callable object that pre-processes the raw
                ...
                'grappa_data', 'target', 'attributes', 'filename', and 'slice' as
    ...
    def _retrieve_metadata(self, fname):
        with h5py.File(fname, "r") as hf:
            ...
            ##################################################################################
            # Should be the same number of slices as the number of slices in the grappa data #
            ##################################################################################
    ...
    def __getitem__(self, i: int):
        ...
        with h5py.File(fname, "r") as hf:
            ...
            grappa_data = hf["grappa_data"][dataslice]
        ...
        if self.transform is None:
            # sample = (grappa_data, mask, target, attrs, fname.name, dataslice)
            sample = (grappa_data, target, attrs, fname.name, dataslice)
        else:
            # sample = self.transform(grappa_data, mask, target, attrs, fname.name, dataslice)
            sample = self.transform(grappa_data, target, attrs, fname.name, dataslice)
