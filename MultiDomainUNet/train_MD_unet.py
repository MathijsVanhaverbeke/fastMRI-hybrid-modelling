...
from multi_domain_model import MultiDomainModel
...
class DataTransform:
    ...
    def __init__(self, resolution, which_challenge, mask_func=None, use_seed=True, standardize=False, apply_grappa=False):
        """
        Args:
        ...
        self.apply_grappa = apply_grappa
    ...
    def __call__(self, kspace, target, attrs, fname, slice):
        ...
        if self.apply_grappa:
            print('in grappa')
            masked_kspace = transforms.apply_grappa(masked_kspace, mask)
        ...
        if self.standardize:
            ...
            image = transforms.standardize_multi_coil_image(tensor_to_complex_np(masked_kspace),
...
class UnetMRIModel(MRIModel):
    ...
    def forward(self, input):
        return self.MD_unet(input.unsqueeze(1)).squeeze(1)
    ...
    def train_data_transform(self):
        ...
        return DataTransform(self.hparams.resolution, self.hparams.challenge, mask, use_seed=False,
                            standardize=self.hparams.standardize, apply_grappa=self.hparams.apply_grappa)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--exp-dir', type=pathlib.Path, default='/home/mvhave7/GitLab/master_thesis/MultiDomainUNet/Checkpoints/',
